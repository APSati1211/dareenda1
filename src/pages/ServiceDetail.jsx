        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    {service.image ? (
                        <div className="relative rounded-2xl border border-slate-200 overflow-hidden aspect-video shadow-2xl">
                            <img 
                                src={service.image} 
                                alt={service.title} 
                        ...
                        <div className="relative bg-white rounded-2xl border border-slate-200 p-8 aspect-video flex flex-col justify-center items-center text-center shadow-lg">
